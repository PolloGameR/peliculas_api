<template>
   <div class="movie-card" :style="{'background-image':'url(https://image.tmdb.org/t/p/w500'+ this.Serie.poster_path+')'}">
  ...
  <div class="container">
    ...
    <div class="hero">
      ...
      <div class="details">
        ...
        <div class="title1">{{this.Serie.original_name}}</div>
    ...
    <div class="description">
      ...
      <div class="column1">
        <span v-for="item in this.Serie.genres" :key="item" class="tag">{{item.name}}</span>        
      </div> <!-- end column1 -->
...
const API_URL_PELICULAS=BASE_URL+"/tv/" ;
